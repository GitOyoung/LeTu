...
/**
 * 引擎运行时，每隔 RECORD_INTERVAL_CALLBACK 会触发一次回调，通知应用已经运行的时长( 当前时间 - 引擎开始时间 )。
 * 可用于更新录音进度条
 */
-(void)aiSpeechEngineIsRecording:(AiSpeechEngine *)engine passedTime:(NSTimeInterval)passedTime;
